...
#define DEFAULT_angle 12

#define DEFAULT_inset 2
#define DEFAULT_stripeWidth 3
...
-(void)startAnimation:(id)sender {
    if (!self.animator) {
        self.animator = [NSTimer scheduledTimerWithTimeInterval:0.1 target:self selector:@selector(activateAnimation:) userInfo:nil repeats:YES];
    }
}
